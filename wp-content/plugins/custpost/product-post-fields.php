...
function products_register_meta_boxes( $meta_boxes )
{
	...
	$meta_boxes[] = array(
		...
		'fields'     => array(
            ...
            // CHECKBOX FÖRVALD (visas som produkt exempel på startsidan)
            array(
				'name' => esc_html__( 'Visa på startsidan', 'your-prefix' ),
				'id'   => "{$prefix}default-post",
				'type' => 'checkbox',
				// Value can be 0 or 1
				'std'  => 0,
			),
            ...
            // TAXONOMY OMRÅDE
			array(
				'name'       => esc_html__( 'Område', 'product' ),
				'id'         => "{$prefix}area",
				'type'       => 'taxonomy',
				// Taxonomy name
				'taxonomy'   => 'omrade',
            ...
            // TAXONOMY HABITAT
            array(
				'name'       => esc_html__( 'Habitat / Naturtyp
                ', 'product' ),
				'id'         => "{$prefix}habitat",
				'type'       => 'taxonomy',
				// Taxonomy name
            ...
            // TAXONOMY AKTIVITET
             array(
				'name'       => esc_html__( 'Aktivitet', 'product' ),
				'id'         => "{$prefix}activity",
				'type'       => 'taxonomy',
				// Taxonomy name
				'taxonomy'   => 'aktivitet',
