	...
	switch($items_type){
		case 'tasks' :
			...
			$aDBc_items_categories_info = array(
					...
					'o'		=> array('name' => __('Orphan tasks','advanced-db-cleaner'),	'color' => '#E97F31', 	'count' => "--"),
					'p'		=> array('name' => __('Plugins tasks', 'advanced-db-cleaner'),	'color' => '#00BAFF', 	'count' => "--"),
					't'		=> array('name' => __('Themes tasks', 'advanced-db-cleaner'),	'color' => '#45C966', 	'count' => "--"),
					'w'		=> array('name' => __('WP tasks', 'advanced-db-cleaner'),		'color' => '#D091BE', 	'count' => "--")
					);
			break;
		case 'options' :
			...
			$aDBc_items_categories_info = array(
					...
					'o'		=> array('name' => __('Orphan options','advanced-db-cleaner'),	'color' => '#E97F31', 	'count' => "--"),
					'p'		=> array('name' => __('Plugins options', 'advanced-db-cleaner'),'color' => '#00BAFF', 	'count' => "--"),
					't'		=> array('name' => __('Themes options', 'advanced-db-cleaner'),	'color' => '#45C966', 	'count' => "--"),
					'w'		=> array('name' => __('WP options', 'advanced-db-cleaner'),		'color' => '#D091BE', 	'count' => "--")
					);
			break;
		case 'tables' :
			...
			$aDBc_items_categories_info = array(
					...
					'o'		=> array('name' => __('Orphan tables','advanced-db-cleaner'),	'color' => '#E97F31', 	'count' => "--"),
					'p'		=> array('name' => __('Plugins tables', 'advanced-db-cleaner'),	'color' => '#00BAFF', 	'count' => "--"),
					't'		=> array('name' => __('Themes tables', 'advanced-db-cleaner'),	'color' => '#45C966', 	'count' => "--"),
					'w'		=> array('name' => __('WP tables', 'advanced-db-cleaner'),		'color' => '#D091BE', 	'count' => "--")
					);
			break;
	}

	// Prepare items to display
	$belongs_to = '<span style="color:#cecece">' . __('Available in Pro version!', 'advanced-db-cleaner') . '</span>';
