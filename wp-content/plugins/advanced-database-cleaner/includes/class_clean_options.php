		...
		<div class="aDBc-content-max-width">
			<form id="aDBc_form" action="" method="post">
				...
				<div class="aDBc-margin-t-20">
					<input id="aDBc_new_search_button" type="submit" class="button-primary aDBc-run-new-search" value="<?php _e('Detect orphan options','advanced-db-cleaner'); ?>"  name="aDBc_new_search_button"/>
